...
After numeric transformation, the result of logical vector remains the same, indicationg the fraction of "TRUE" out of all items in it. 

The result of character vector is still NA, since there's no way to set characters as digits.

The result of factor vector is done by transforming all categories indicator into numbers. Therefore, we're actually calculating the mean of two 1s, two 2s and four 3s.
